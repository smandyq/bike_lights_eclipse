...
#define FIREBALL_SPEED_DIVISOR_MIN 3 //maximum power of two to make the speed divisor
...
#define FIREBALL_MIN_LUT_INC 3  //minimum amount of shortening of the tail of the fireball
